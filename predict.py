...
# Argument parser
parser.add_argument('input', default='./assets/Flowers.png', nargs='?', type=str, help="Path to input image")
parser.add_argument('--dir', default="./assets/", type=str, help="Path to data directory")
